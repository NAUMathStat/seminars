...
I'm imagining using mini blog posts to advertise each week's announcements.  Each blog post will be a unique file in the `_posts` folder.  The filename should have the following convention: `year-mont-day-short-title.md`.  For example, this post is named `2015-01-26-sample-post.md`.
